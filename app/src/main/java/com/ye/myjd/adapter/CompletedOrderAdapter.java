 ...
 * @desc :
 */
public class CompletedOrderAdapter extends OrderBaseAdapter {
    public CompletedOrderAdapter(Context c) {
        super(c);
    }
...
//            do_btn.setOnClickListener(CompletedOrderAdapter.this);
//            do_btn.setText("收货");
//            do_btn.setVisibility(View.VISIBLE);
        }

        public void setData(int position) {
            ROrderByStatus rOrderByStatus = mDatas.get(position);
