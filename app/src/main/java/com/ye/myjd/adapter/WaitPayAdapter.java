...
import com.ye.myjd.listener.IOnOrderItemClickListener;
...
public class WaitPayAdapter extends OrderBaseAdapter {
    private IOnOrderItemClickListener mListener;

    public WaitPayAdapter(Context c) {
        super(c);
    }

    public void setIOnOrderPayClickListener(IOnOrderItemClickListener listener) {
        mListener = listener;
    }
...
//            order_state_tv.setText(rOrderByStatus.getStatus());
            ...
            do_btn.setOnClickListener(WaitPayAdapter.this);
}
    }
}
